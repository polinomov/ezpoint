...
namespace ezp 
{
  struct UIImpl : public UI
  {
    ...
    UIImpl():m_colorMode(UICOLOR_INTENS){ 
      ...
      m_strToCall["colrgbId"]   = [](int val){Renderer::Get()->SetColorMode(UICOLOR_RGB);};
      m_strToCall["colintId"]   = [](int val){Renderer::Get()->SetColorMode(UICOLOR_INTENS);};
      m_strToCall["colhtmId"]   = [](int val){Renderer::Get()->SetColorMode(UICOLOR_HMAP);};
      m_strToCall["colclassId"] = [](int val){Renderer::Get()->SetColorMode(UICOLOR_CLASS);};
      m_strToCall["colmix"]     = [](int val){Renderer::Get()->SetColorMode(UICOLOR_MIX);};
